...
const signInWithEmailAndPassword = (
  signInData: IUserSignInData,
): AppThunk => async (dispatch) => buildRequestAndDispatchAction(async () => {
...
const signOut = (): AppThunk => async (dispatch) => buildRequestAndDispatchAction(async () => {
